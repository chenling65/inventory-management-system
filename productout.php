...
<head>
  ...
  <script>
    ...
    function calculateTotal() {
        var subtotalInput = document.querySelector('input[name="total"]');
...
<body>
    <nav>
        ...
        <a href="productout.php"class="edit-link"><span class="arrow-icon">&#9658;</span> PRODUCT OUT <span class="arrow-icon">&#9664</span></a>
        <a href="formstaff.php">EDIT STAFF</a>

    </nav>
  <div class="container">
    <header class="header">Product Out</header>
    <form action="updateout.php" method="POST">
            ...
            <div class="column" id="cost-receipt-column">
                ...
                <tr>
                 ...
                 <tr>
                    <td>Total:</td>
                    <td>
                        <input type="text" name="total" placeholder="Unit Price*Quantities" style="font-size: 15px;">
